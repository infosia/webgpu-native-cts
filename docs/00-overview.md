...
| Language | **C++17 throughout** (tests and harness); tests call the WebGPU **C** API | The upstream framework is OO/fluent/closure-based; C++ ports to it almost 1:1, maximizing fidelity. (Originally scoped as C; relaxed to C++ for the test surface.) |
