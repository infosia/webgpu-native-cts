...
| Area | Ported* | Note |
|------|--------:|------|
| `api/validation` | 78 / 129 | Y-6 V1–V6 (createBindGroup, compute/render pipeline, render_pass, encoding, image_copy); 3 N/A; 48 todo |
...
|---------|------|:-----:|:----------------:|---------------|
| **yawgpu** | primary subject | ✅ green | ✅ green | **5** — F-089/F-090/F-092/F-093/F-094 (createBindGroup, fragment-state, render-pass, encoding, image-copy validation), all cross-HAL; 64 earlier findings fixed |
...
### Findings — 94 surfaced to date (F-001…F-094)
...
|--------|--:|-------------------------|
| yawgpu — open | 5 | F-089/F-090/F-092/F-093/F-094 (createBindGroup, fragment-state, render-pass, encoding, image-copy validation) — all cross-HAL, Dawn-oracle-confirmed |
