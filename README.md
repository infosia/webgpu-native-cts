...
| Area | Ported* | Note |
|------|--------:|------|
| `api/validation` | 75 / 129 | Y-6 V1–V5 (createBindGroup, compute_pipeline, render_pipeline, render_pass, encoding); 3 N/A; 51 todo |
...
|---------|------|:-----:|:----------------:|---------------|
| **yawgpu** | primary subject | ✅ green | ✅ green | **4** — F-089/F-090/F-092/F-093 (createBindGroup sampler, fragment-state, render-pass, encoding validation), all cross-HAL; 64 earlier findings fixed |
...
### Findings — 93 surfaced to date (F-001…F-093)
...
|--------|--:|-------------------------|
| yawgpu — open | 4 | F-089 (createBindGroup sampler), F-090 (fragment-state), F-092 (render-pass), F-093 (encoding/copy validation) — all cross-HAL, Dawn-oracle-confirmed |
