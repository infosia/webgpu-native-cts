...
| Area | Ported* | Note |
|------|--------:|------|
| `api/validation` | 80 / 129 | Y-6 V1–V7a (createBindGroup, pipelines, render_pass, encoding, image_copy, resource_usages/buffer); 3 N/A; 46 todo |
...
|---------|------|:-----:|:----------------:|---------------|
| **yawgpu** | primary subject | ✅ green | ✅ green | **6** — F-089/F-090/F-092/F-093/F-094/F-095 (createBindGroup, fragment-state, render-pass, encoding, image-copy, buffer usage-scope validation), all cross-HAL; 64 earlier findings fixed |
...
### Findings — 95 surfaced to date (F-001…F-095)
...
|--------|--:|-------------------------|
| yawgpu — open | 6 | F-089/F-090/F-092/F-093/F-094/F-095 (createBindGroup, fragment-state, render-pass, encoding, image-copy, buffer usage-scope) — all cross-HAL, Dawn-oracle-confirmed |
