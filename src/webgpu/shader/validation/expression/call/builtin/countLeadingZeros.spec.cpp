...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/countLeadingZeros.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
constexpr const char* kBuiltin = "countLeadingZeros";

TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,countLeadingZeros",
    "Validation tests for the countLeadingZeros() builtin.");

// kValuesTypes = kConcreteIntegerScalarsAndVectors
CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of countLeadingZeros() never "
          "errors")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        // countLeadingZeros() should never error
...
CTS_TEST(g, "float_argument")
    .desc("Validates that float arguments are rejected by countLeadingZeros()")
...
CTS_TEST(g, "arguments")
    .desc("Test compilation validation of countLeadingZeros with variously shaped and typed "
          "arguments")
...
CTS_TEST(g, "must_use")
    .desc("Result of countLeadingZeros must be used")
