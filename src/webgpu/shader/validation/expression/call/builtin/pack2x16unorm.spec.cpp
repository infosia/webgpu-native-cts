...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/pack2x16unorm.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
constexpr const char* kFn = "pack2x16unorm";
constexpr const char* kReturnType = "u32";
constexpr const char* kGoodArgs = "(vec2f())";

TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,pack2x16unorm", "Validate pack2x16unorm");
...
CTS_TEST(g, "args")
    .desc("Test compilation failure of pack2x16unorm with various numbers of and types of arguments")
...
CTS_TEST(g, "return")
    .desc("Test pack2x16unorm return value type")
...
CTS_TEST(g, "must_use")
    .desc("Result of pack2x16unorm must be used")
