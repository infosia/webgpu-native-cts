...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/modf.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,modf", "Validation tests for the modf() builtin.");

CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of modf() rejects invalid "
          "values")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        b::validateConstOrOverrideBuiltinEval(t, "modf", /*expectedResult=*/true,
...
CTS_TEST(g, "integer_argument")
    .desc("Validates that scalar and vector integer arguments are rejected by modf()")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        b::validateConstOrOverrideBuiltinEval(t, "modf", expectedResult,
...
CTS_TEST(g, "arguments")
    .desc("Test compilation validation of modf with variously shaped and typed arguments")
...
CTS_TEST(g, "must_use")
    .desc("Result of modf must be used")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        t.expectCompileResult(use, "fn f() { " + useIt + "modf(1.0f); }");
    });
