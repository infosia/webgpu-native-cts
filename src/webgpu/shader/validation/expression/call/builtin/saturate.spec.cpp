...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/saturate.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,saturate",
    "Validation tests for the saturate() builtin.");

CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of saturate() inputs rejects "
          "invalid values")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        b::validateConstOrOverrideBuiltinEval(t, "saturate", /*expectedResult=*/true,
...
CTS_TEST(g, "integer_argument")
    .desc("Validates that scalar and vector integer arguments are rejected by saturate()")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        b::validateConstOrOverrideBuiltinEval(t, "saturate", expectedResult,
...
CTS_TEST(g, "arguments")
    .desc("Test compilation validation of saturate with variously shaped and typed arguments")
...
CTS_TEST(g, "must_use")
    .desc("Result of saturate must be used")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        t.expectCompileResult(use, "fn f() { " + useIt + "saturate(1.0f); }");
    });
