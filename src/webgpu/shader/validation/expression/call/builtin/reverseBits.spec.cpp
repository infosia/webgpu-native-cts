...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/reverseBits.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
constexpr const char* kBuiltin = "reverseBits";

TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,reverseBits",
    "Validation tests for the reverseBits() builtin.");

// kValuesTypes = kConcreteIntegerScalarsAndVectors
CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of reverseBits() never "
          "errors")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        // reverseBits() should never error
...
CTS_TEST(g, "float_argument")
    .desc("Validates that float arguments are rejected by reverseBits()")
...
CTS_TEST(g, "arguments")
    .desc("Test compilation validation of reverseBits with variously shaped and typed arguments")
...
CTS_TEST(g, "must_use")
    .desc("Result of reverseBits must be used")
