...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/trunc.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,trunc", "Validation tests for the trunc() builtin.");

CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of trunc() error on invalid "
          "inputs.")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        b::validateConstOrOverrideBuiltinEval(t, "trunc", /*expectedResult=*/true,
...
CTS_TEST(g, "args")
    .desc("Test compilation failure of trunc with variously shaped and typed arguments")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        t.expectCompileResult(std::string(c.name) == "good",
                              std::string("const c = trunc") + c.suffix + ";");
    });

CTS_TEST(g, "must_use")
    .desc("Result of trunc must be used")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        t.expectCompileResult(use, "fn f() { " + useIt + "trunc(1.2); }");
    });
