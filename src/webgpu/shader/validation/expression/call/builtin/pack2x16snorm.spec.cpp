...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/pack2x16snorm.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
constexpr const char* kFn = "pack2x16snorm";
constexpr const char* kReturnType = "u32";

TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,pack2x16snorm", "Validate pack2x16snorm");

// kArgCases: name -> (call-arg suffix, good?). Order preserved exactly.
struct ArgCase {
    const char* name;
    const char* args;
};
...
static const char* kGoodArgs = "(vec2f())";

CTS_TEST(g, "args")
    .desc("Test compilation failure of pack2x16snorm with various numbers of and types of arguments")
...
CTS_TEST(g, "return")
    .desc("Test pack2x16snorm return value type")
...
CTS_TEST(g, "must_use")
    .desc("Result of pack2x16snorm must be used")
