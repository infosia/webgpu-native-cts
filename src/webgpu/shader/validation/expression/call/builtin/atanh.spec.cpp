...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/atanh.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,atanh", "Validation tests for the atanh() builtin.");

CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of atanh() rejects invalid "
          "values")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        b::validateConstOrOverrideBuiltinEval(t, "atanh", expectedResult,
...
CTS_TEST(g, "integer_argument")
    .desc("Validates that scalar and vector integer arguments are rejected by atanh()")
...
static const std::vector<ParamTest>& kTests() {
    static const std::vector<ParamTest> v = {
        {"valid", "_ = atanh(.1);", true},
        {"alias", "_ = atanh(f32_alias(.1));", true},
        {"bool", "_ = atanh(false);", false},
        {"i32", "_ = atanh(0i);", false},
        {"u32", "_ = atanh(0u);", false},
        {"vec_bool", "_ = atanh(vec2<bool>(false, true));", false},
        {"vec_i32", "_ = atanh(vec2<i32>(0, 0));", false},
        {"vec_u32", "_ = atanh(vec2<u32>(0, 0));", false},
        {"matrix", "_ = atanh(mat2x2(0, 0, 0, 0));", false},
        {"atomic", " _ = atanh(a);", false},
        {"array", "var a: array<u32, 5>;\n          _ = atanh(a);", false},
        {"array_runtime", "_ = atanh(k.arry);", false},
        {"struct", "var a: A;\n          _ = atanh(a);", false},
        {"enumerant", "_ = atanh(read_write);", false},
        {"ptr",
        ...
        {"ptr_deref",
         ...
         "atanh(*p);",
         true},
        {"sampler", "_ = atanh(s);", false},
        {"texture", "_ = atanh(t);", false},
        {"no_params", "_ = atanh();", false},
        {"too_many_params", "_ = atanh(0, .2);", false},
        {"one", "_ = atanh(1f);", false},
        {"greater_then_one", "_ = atanh(1.1f);", false},
        {"negative_one", "_ = atanh(-1f);", false},
        {"less_then_negative_one", "_ = atanh(-1.1f);", false},
        {"must_use", "atanh(0.1);", false},
    };
    return v;
}
...
CTS_TEST(g, "parameters")
    .desc("Test that atanh is validated correctly.")
