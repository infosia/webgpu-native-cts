...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/pack4x8snorm.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
constexpr const char* kFn = "pack4x8snorm";
constexpr const char* kReturnType = "u32";
constexpr const char* kGoodArgs = "(vec4f())";

TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,pack4x8snorm", "Validate pack4x8snorm");
...
CTS_TEST(g, "args")
    .desc("Test compilation failure of pack4x8snorm with various numbers of and types of arguments")
...
CTS_TEST(g, "return")
    .desc("Test pack4x8snorm return value type")
...
CTS_TEST(g, "must_use")
    .desc("Result of pack4x8snorm must be used")
