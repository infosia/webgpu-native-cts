...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/countOneBits.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
constexpr const char* kBuiltin = "countOneBits";

TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,countOneBits",
    "Validation tests for the countOneBits() builtin.");

// kValuesTypes = kConcreteIntegerScalarsAndVectors
CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of countOneBits() never "
          "errors")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        // countOneBits() should never error
...
CTS_TEST(g, "float_argument")
    .desc("Validates that float arguments are rejected by countOneBits()")
...
CTS_TEST(g, "arguments")
    .desc("Test compilation validation of countOneBits with variously shaped and typed arguments")
...
CTS_TEST(g, "must_use")
    .desc("Result of countOneBits must be used")
