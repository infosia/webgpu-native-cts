...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/atan.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,atan", "Validation tests for the atan() builtin.");

CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of atan() rejects invalid "
          "values")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        b::validateConstOrOverrideBuiltinEval(t, "atan", /*expectedResult=*/true,
...
CTS_TEST(g, "integer_argument")
    .desc("Validates that scalar and vector integer arguments are rejected by atan()")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        b::validateConstOrOverrideBuiltinEval(t, "atan", expectedResult,
...
static const std::vector<ParamTest>& kTests() {
    static const std::vector<ParamTest> v = {
        {"valid", "_ = atan(1);", true},
        {"alias", "_ = atan(f32_alias(1));", true},
        {"bool", "_ = atan(false);", false},
        {"i32", "_ = atan(1i);", false},
        {"u32", "_ = atan(1u);", false},
        {"vec_bool", "_ = atan(vec2<bool>(false, true));", false},
        {"vec_i32", "_ = atan(vec2<i32>(1, 1));", false},
        {"vec_u32", "_ = atan(vec2<u32>(1, 1));", false},
        {"matrix", "_ = atan(mat2x2(1, 1, 1, 1));", false},
        {"atomic", " _ = atan(a);", false},
        {"array", "var a: array<u32, 5>;\n          _ = atan(a);", false},
        {"array_runtime", "_ = atan(k.arry);", false},
        {"struct", "var a: A;\n          _ = atan(a);", false},
        {"enumerant", "_ = atan(read_write);", false},
        {"ptr",
        ...
        {"ptr_deref",
         "var<function> a = 1f;\n          let p: ptr<function, f32> = &a;\n          _ = atan(*p);",
         true},
        {"sampler", "_ = atan(s);", false},
        {"texture", "_ = atan(t);", false},
        {"no_params", "_ = atan();", false},
        {"too_many_params", "_ = atan(1, 2);", false},
        {"must_use", "atan(1);", false},
    };
    return v;
}
...
CTS_TEST(g, "parameters")
    .desc("Test that atan is validated correctly.")
