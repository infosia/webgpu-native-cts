...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/cos.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,cos", "Validation tests for the cos() builtin.");
...
CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of cos() rejects invalid "
          "values")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        b::validateConstOrOverrideBuiltinEval(t, "cos", /*expectedResult=*/true,
                                              {b::createBuiltinValue(ty, rv)}, stage);
    });

CTS_TEST(g, "integer_argument")
    .desc("Validates that scalar and vector integer arguments are rejected by cos()")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        b::validateConstOrOverrideBuiltinEval(t, "cos", expectedResult,
...
CTS_TEST(g, "args")
    .desc("Test compilation failure of cos with variously shaped and typed arguments")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        t.expectCompileResult(std::string(c.name) == "good",
                              std::string("const c = cos") + c.suffix + ";");
    });

CTS_TEST(g, "must_use")
    .desc("Result of cos must be used")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        t.expectCompileResult(use, "fn f() { " + useIt + "cos(1.1); }");
    });
