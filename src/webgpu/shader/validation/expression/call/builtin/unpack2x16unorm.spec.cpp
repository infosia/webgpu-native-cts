...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/unpack2x16unorm.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
constexpr const char* kBuiltin = "unpack2x16unorm";
constexpr const char* kReturnType = "vec2<f32>";

TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,unpack2x16unorm",
    "Validation tests for the unpack2x16unorm builtin.");
...
CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of unpack2x16unorm rejects "
          "invalid values.")
...
CTS_TEST(g, "arguments")
    .desc("Test that unpack2x16unorm is validated correctly when called with different arguments.")
    .params([](ParamsBuilder u) {
...
CTS_TEST(g, "must_use")
    .desc("Result of unpack2x16unorm must be used")
