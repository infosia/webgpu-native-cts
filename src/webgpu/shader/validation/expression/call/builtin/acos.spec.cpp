...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/acos.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,acos", "Validation tests for the acos() builtin.");

// kValuesTypes = kConvertableToFloatScalarsAndVectors
CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of acos() rejects invalid "
          "values")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        b::validateConstOrOverrideBuiltinEval(t, "acos", expectedResult,
                                              {b::createBuiltinValue(ty, rv)}, stage);
    });

// kIntegerArgumentTypes = [Type.f32, ...kConcreteIntegerScalarsAndVectors]
...
CTS_TEST(g, "integer_argument")
    .desc("Validates that scalar and vector integer arguments are rejected by acos()")
...
static const std::vector<ParamTest>& kTests() {
    static const std::vector<ParamTest> v = {
        {"valid", "_ = acos(1);", true},
        {"alias", "_ = acos(f32_alias(1));", true},
        {"bool", "_ = acos(false);", false},
        {"i32", "_ = acos(1i);", false},
        {"u32", "_ = acos(1u);", false},
        {"vec_bool", "_ = acos(vec2<bool>(false, true));", false},
        {"vec_i32", "_ = acos(vec2<i32>(1, 1));", false},
        {"vec_u32", "_ = acos(vec2<u32>(1, 1));", false},
        {"matrix", "_ = acos(mat2x2(1, 1, 1, 1));", false},
        {"atomic", " _ = acos(a);", false},
        {"array", "var a: array<u32, 5>;\n          _ = acos(a);", false},
        {"array_runtime", "_ = acos(k.arry);", false},
        {"struct", "var a: A;\n          _ = acos(a);", false},
        {"enumerant", "_ = acos(read_write);", false},
        {"ptr",
        ...
        {"ptr_deref",
         "var<function> a = 1f;\n          let p: ptr<function, f32> = &a;\n          _ = acos(*p);",
         true},
        {"sampler", "_ = acos(s);", false},
        {"texture", "_ = acos(t);", false},
        {"no_params", "_ = acos();", false},
        {"too_many_params", "_ = acos(1, 2);", false},
        {"greater_then_one", "_ = acos(1.1f);", false},
        {"less_then_negative_one", "_ = acos(-1.1f);", false},
        {"must_use", "acos(1);", false},
    };
    return v;
}
...
CTS_TEST(g, "parameters")
    .desc("Test that acos is validated correctly.")
