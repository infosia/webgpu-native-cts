...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/unpack4xU8.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
constexpr const char* kBuiltin = "unpack4xU8";
constexpr const char* kReturnType = "vec4<u32>";

TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,unpack4xU8",
    "Validation tests for the unpack4xU8 builtin.");
...
CTS_TEST(g, "unsupported")
    .desc("Test absence of unpack4xU8 when packed_4x8_integer_dot_product is not supported.")
...
CTS_TEST(g, "supported")
    .desc("Test presence of unpack4xU8 when packed_4x8_integer_dot_product is supported.")
    .params([](ParamsBuilder u) { return u.combine("requires", {Value(false), Value(true)}); })
    .fn([](ShaderValidationTest& t) {
...
CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of unpack4xU8 rejects invalid "
          "values.")
...
CTS_TEST(g, "arguments")
    .desc("Test that unpack4xU8 is validated correctly when called with different arguments.")
    .params([](ParamsBuilder u) {
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        //   [enable f16;]\nconst v : <returnType> = unpack4xU8(<args>);
...
CTS_TEST(g, "must_use")
    .desc("Result of unpack4xU8 must be used")
