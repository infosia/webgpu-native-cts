...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/dot4I8Packed.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
constexpr const char* kFn = "dot4I8Packed";

TestGroup<ShaderValidationTest> g =
    MakeTestGroup<ShaderValidationTest>("shader,validation,expression,call,builtin,dot4I8Packed",
                                        "Validate dot4I8Packed");
...
CTS_TEST(g, "unsupported")
    .desc("Test absence of dot4I8Packed when packed_4x8_integer_dot_product is not supported.")
...
CTS_TEST(g, "supported")
    .desc("Test presence of dot4I8Packed when packed_4x8_integer_dot_product is supported.")
    .params([](ParamsBuilder u) { return u.combine("requires", {Value(false), Value(true)}); })
    .fn([](ShaderValidationTest& t) {
...
CTS_TEST(g, "args")
    .desc("Test compilation failure of dot4I8Packed with various numbers of and types of arguments")
...
CTS_TEST(g, "must_use")
    .desc("Result of dot4I8Packed must be used")
