...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/asinh.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,asinh", "Validation tests for the asinh() builtin.");
...
// additionalRangeForType = rangeForType(linearRange(-2000,2000,10),
//                                       linearRangeBigInt(-2000n,2000n,10)).
static std::vector<b::RangeValue> additionalRangeForType(const bt::Type& ty) {
    return b::rangeForType(ty, b::linearRange(-2000.0, 2000.0, 10),
                           b::linearRangeBigInt(-2000, 2000, 10));
}

CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of asinh() rejects invalid "
          "values")
        ...
        return u.combine("stage", b::kConstantAndOverrideStages())
            ...
            .expand("value", [](const ParamRecord& p) {
                ...
                return b::rangeValues(
                    b::uniqueRanges({b::fullRangeForType(ty), additionalRangeForType(ty)}));
            });
    })
    .fn([](ShaderValidationTest& t) {
        ...
        const bool expectedResult = b::isRepresentable(std::asinh(num), isReprKind(ty));
        b::validateConstOrOverrideBuiltinEval(t, "asinh", expectedResult,
...
CTS_TEST(g, "integer_argument")
    .desc("Validates that scalar and vector integer arguments are rejected by asinh()")
...
static const std::vector<ParamTest>& kTests() {
    static const std::vector<ParamTest> v = {
        {"valid", "_ = asinh(1);", true},
        {"alias", "_ = asinh(f32_alias(1));", true},
        {"bool", "_ = asinh(false);", false},
        {"i32", "_ = asinh(1i);", false},
        {"u32", "_ = asinh(1u);", false},
        {"vec_bool", "_ = asinh(vec2<bool>(false, true));", false},
        {"vec_i32", "_ = asinh(vec2<i32>(1, 1));", false},
        {"vec_u32", "_ = asinh(vec2<u32>(1, 1));", false},
        {"matrix", "_ = asinh(mat2x2(1, 1, 1, 1));", false},
        {"atomic", " _ = asinh(a);", false},
        {"array", "var a: array<u32, 5>;\n          _ = asinh(a);", false},
        {"array_runtime", "_ = asinh(k.arry);", false},
        {"struct", "var a: A;\n          _ = asinh(a);", false},
        {"enumerant", "_ = asinh(read_write);", false},
        {"ptr",
        ...
        {"ptr_deref",
         ...
         "asinh(*p);",
         true},
        {"sampler", "_ = asinh(s);", false},
        {"texture", "_ = asinh(t);", false},
        {"no_params", "_ = asinh();", false},
        {"too_many_params", "_ = asinh(1, 2);", false},
        {"must_use", "asinh(1);", false},
    };
    return v;
}
...
CTS_TEST(g, "parameters")
    .desc("Test that asinh is validated correctly.")
