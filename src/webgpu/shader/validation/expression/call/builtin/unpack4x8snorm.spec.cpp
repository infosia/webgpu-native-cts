...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/call/builtin/unpack4x8snorm.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
constexpr const char* kBuiltin = "unpack4x8snorm";
constexpr const char* kReturnType = "vec4<f32>";

TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,call,builtin,unpack4x8snorm",
    "Validation tests for the unpack4x8snorm builtin.");
...
CTS_TEST(g, "values")
    .desc("Validates that constant evaluation and override evaluation of unpack4x8snorm rejects "
          "invalid values.")
...
CTS_TEST(g, "arguments")
    .desc("Test that unpack4x8snorm is validated correctly when called with different arguments.")
    .params([](ParamsBuilder u) {
...
CTS_TEST(g, "must_use")
    .desc("Result of unpack4x8snorm must be used")
