...
// Ported from gpuweb/cts src/webgpu/shader/validation/expression/matrix/and_or_xor.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
TestGroup<ShaderValidationTest> g = MakeTestGroup<ShaderValidationTest>(
    "shader,validation,expression,matrix,and_or_xor",
...
CTS_TEST(g, "invalid")
    ...
    .fn([](ShaderValidationTest& t) {
        ...
        const bool pass = (lhs == "1i" || lhs == "1") && (rhs == "1i" || rhs == "1");
