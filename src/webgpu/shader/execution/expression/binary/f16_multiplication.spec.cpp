// Ported from gpuweb/cts src/webgpu/shader/execution/expression/binary/f16_multiplication.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
// SPDX-License-Identifier: BSD-3-Clause
// Upstream CTS: Copyright (c) The WebGPU CTS Contributors, BSD-3-Clause.
// Port:         Copyright (c) the webgpu-native-cts contributors, BSD-3-Clause.
//
// Execution tests for non-matrix f16 multiplication (x * y). Accuracy: correctly rounded.
// Mirrors f32_multiplication but uses the f16 traits + f16 ranges; gated on the 'shader-f16' feature.
...
TestGroup<AllFeaturesMaxLimitsGpuTest> g = MakeTestGroup<AllFeaturesMaxLimitsGpuTest>(
    "shader,execution,expression,binary,f16_multiplication",
...
// FP.f16.multiplicationInterval(x, y).
fp::FPInterval mulOp(double x, double y) { return fp::multiplicationInterval(fp::FPKind::F16, x, y); }
