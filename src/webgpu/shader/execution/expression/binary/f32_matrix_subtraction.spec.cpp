// Ported from gpuweb/cts src/webgpu/shader/execution/expression/binary/f32_matrix_subtraction.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
// SPDX-License-Identifier: BSD-3-Clause
// Upstream CTS: Copyright (c) The WebGPU CTS Contributors, BSD-3-Clause.
// Port:         Copyright (c) the webgpu-native-cts contributors, BSD-3-Clause.
//
// Execution tests for matrix f32 subtraction (x - y, componentwise). Accuracy: correctly rounded.
...
TestGroup<AllFeaturesMaxLimitsGpuTest> g = MakeTestGroup<AllFeaturesMaxLimitsGpuTest>(
    "shader,execution,expression,binary,f32_matrix_subtraction",
...
fp::MatrixPairToMatrix subMatOp() {
    return [](const std::vector<std::vector<double>>& x,
        ...
        return fp::subtractionMatrixMatrixInterval(fp::FPKind::F32, x, y);
    };
}
