// Ported from gpuweb/cts src/webgpu/shader/execution/expression/binary/f32_addition.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
// SPDX-License-Identifier: BSD-3-Clause
// Upstream CTS: Copyright (c) The WebGPU CTS Contributors, BSD-3-Clause.
// Port:         Copyright (c) the webgpu-native-cts contributors, BSD-3-Clause.
//
// Execution tests for non-matrix f32 addition (x + y). Accuracy: correctly rounded.
...
TestGroup<AllFeaturesMaxLimitsGpuTest> g = MakeTestGroup<AllFeaturesMaxLimitsGpuTest>(
    "shader,execution,expression,binary,f32_addition",
...
// FP.f32.additionInterval(x, y).
fp::FPInterval addOp(double x, double y) { return fp::additionInterval(fp::FPKind::F32, x, y); }
