// Ported from gpuweb/cts src/webgpu/shader/execution/expression/call/builtin/fwidth.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85
// SPDX-License-Identifier: BSD-3-Clause
// Upstream CTS: Copyright (c) The WebGPU CTS Contributors, BSD-3-Clause.
// Port:         Copyright (c) the webgpu-native-cts contributors, BSD-3-Clause.
//
// Execution tests for the 'fwidth' builtin: abs(dpdx(e)) + abs(dpdy(e)) (fine or coarse).
...
const char* kBuiltin = "fwidth";

TestGroup<AllFeaturesMaxLimitsGpuTest> testGroup = MakeTestGroup<AllFeaturesMaxLimitsGpuTest>(
    "shader,execution,expression,call,builtin,fwidth",
