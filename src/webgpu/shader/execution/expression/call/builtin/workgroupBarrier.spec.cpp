// Ported from gpuweb/cts src/webgpu/shader/execution/expression/call/builtin/workgroupBarrier.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85
...
TestGroup<AllFeaturesMaxLimitsGpuTest> testGroup = MakeTestGroup<AllFeaturesMaxLimitsGpuTest>(
    "shader,execution,expression,call,builtin,workgroupBarrier",
...
CTS_TEST(testGroup, "barrier").desc("fn workgroupBarrier()").unimplemented();
