// Ported from gpuweb/cts src/webgpu/shader/execution/expression/unary/i32_complement.spec.ts @ b507bd117e53db86f2fb52d0d858d3ae7d684a85 (see docs/UPSTREAM.md).
...
TestGroup<AllFeaturesMaxLimitsGpuTest> testGroup = MakeTestGroup<AllFeaturesMaxLimitsGpuTest>(
    "shader,execution,expression,unary,i32_complement",
    "Execution Tests for the i32 bitwise complement operation");
...
CTS_TEST(testGroup, "i32_complement").params(vectorizeParams).fn([](AllFeaturesMaxLimitsGpuTest& t) {
    std::vector<Case> cases;
    for (int32_t e : fullI32Range()) {
        cases.push_back({{CaseValue(i32(e))}, CaseValue(i32(~e))});
    }
